...
<div id="fig_OECD1a"></div>
<div class="row">
<div class="col-md-4">
<div id="fig_OECD1b"></div>
<div id="fig_OECD1e"></div>
</div>
<div class="col-md-4">
<div id="fig_OECD1c"></div>
<div id="fig_OECD1f"></div>
</div>
<div class="col-md-4">
<div id="fig_OECD1d"></div>
<div id="fig_OECD1g"></div>
</div>
</div>
...
function createFig_OECD3(fig_ID,data) {
      ...
      dataSource: data,			
        ...
        tooltip: {
				visible: true,
				template: "TB control (#= category #): #= value.toPrecision(2) # million"
			}
			},{
        ...
        tooltip: {
				visible: true,
				template: "STD control including HIV (#= category #): #= value.toPrecision(2) # million"
			}
			},{
        ...
        tooltip: {
				visible: true,
				template: "Malaria control (#= category #): #= value.toPrecision(2) # million"
			}
			},{
        ...
        tooltip: {
				visible: true,
				template: "Total health and population programmes (#= category #): #= value.toPrecision(2) # million"
			}
			},],
			valueAxis: {
				labels: {
...
$(document).ready(function() {
    createFig_OECD1("#fig_OECD1a",fig_OECD1_data,"Low- and middle-income\ncountriesᵃ");
  createFig_OECD1("#fig_OECD1b",fig_OECD1_data,"WHO African Region");
  createFig_OECD1("#fig_OECD1c",fig_OECD1_data,"WHO Region of\nthe Americas");
  createFig_OECD1("#fig_OECD1d",fig_OECD1_data,"WHO South-East Asia\nRegion");
  createFig_OECD1("#fig_OECD1e",fig_OECD1_data,"WHO European Region");
  createFig_OECD1("#fig_OECD1f",fig_OECD1_data,"WHO Eastern Mediterranean\nRegion");
  createFig_OECD1("#fig_OECD1g",fig_OECD1_data,"WHO Western Pacific\nRegion");
  createFig_OECD3("#fig_OECD3",fig_OECD3_data);
